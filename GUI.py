...
class GraphicalInterfaceClass:
    ...
    def __init__(self, logic: logic):
        ...
        #self.sourcePath.insert(0,"C:\\Users\\srich\\Desktop\\PrintTool_Part1-main")
        ...
        #self.destinationPath.insert(0, "C:\\Users\\srich\\Desktop\\New folder")
    ...
    def StartExecution(self):
        self.Flogic.FileExecution(self.sourcePath.get(), self.destinationPath.get(), self.filenames.get(),
                                  self.countrynames.get())
